...
def call(Map config) {
    ...
    // caprover 2.4.0 (publiee le 05/08/2026) exige Node >= 20 : sur l'image agent
    // Node 16 elle plante en ERR_REQUIRE_ESM. On epingle donc la derniere version
    // compatible. Surchargeable si l'agent passe un jour sur Node >= 20.
        ...
        stages {
            ...
            stage('Install CapRover CLI') {
                steps {
                    ...
                    sh "npm install -g caprover@${caproverVersion}"
                    sh 'caprover --version'
                }
            }
